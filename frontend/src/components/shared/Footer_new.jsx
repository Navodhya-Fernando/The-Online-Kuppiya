        ...
        <div className="border-t border-light pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-secondary text-sm">
              <p>&copy; {currentYear} The Online Kuppiya. All rights reserved.</p>
              <p className="text-muted">Advanced Diploma in Data Science - NIBM, Colombo 05</p>
            </div>
            
            <div className="flex gap-6 text-sm">
              <Link to="/privacy" className="text-secondary hover:text-blue transition-colors">Privacy Policy</Link>
              <Link to="/terms" className="text-secondary hover:text-blue transition-colors">Terms of Service</Link>
              <Link to="/contact" className="text-secondary hover:text-blue transition-colors">Contact Us</Link>
            </div>
          </div>
        </div>
      </div>
